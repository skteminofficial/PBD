(function () {
  ...
  function switchDashboardView(view){
    ...
    document.querySelectorAll('[data-dashboard-view]').forEach(section=>section.classList.toggle('hidden',section.dataset.dashboardView!==wanted));
